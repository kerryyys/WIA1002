...
//QUESTION, where the data store in the linked list? the list we declare, then it will auto check the prev and next since we have a lot of data there
...
public DoublyLinkedList(){
    ...
    public E remove(int index){
        ...
        if(index == (size + 1) /2){    //separate into 2 part, this is front part
            current = head;
            for(int i=0;i<index;i++)
                current = current.next;
        }
        else{     //this is back part
            current=tail;
