    ...
    public static void displayAnswers(String[] actions) {
        ...
        for (String action : actions) {
            ...
            if(actionInfo.length == 1){ //==Ask
                ...
                while(!stack1.isEmpty()){ //will take out all element in stack 1
                ...
                while(!stack2.isEmpty()){ //push back the remaining element after taking out the element for destroy part
    ...
    public static void main(String[] args) {
        final String[][] actionArray = {
                ...
                { "Travel Morioh", "Travel Colosseum", "Travel Cape Canaveral", "Ask", "Travel Morioh",
                        "Travel Sardinia", "Destroy Morioh",
