...
public class TestDS2023Generics
{
    ...
    // TODO: Change this value as you proceed through parts of the question.
    ...
    public static void testCPU () throws java.lang.Exception
    {
        ...
        ArrayList<CpuInt> aa = VecUtil.arr2vecC(CpuInt.class, new int[]{1,2,3});
        ArrayList<CpuInt> bb = VecUtil.onesC(CpuInt.class, 3);
        VecUtil.printVec(aa);
        VecUtil.printVec(bb);
        System.out.println("---");
    ...
    public static void testGPU () throws java.lang.Exception
    {
        ...
        ArrayList<GpuInt> aa = VecUtil.arr2vecG(GpuInt.class, new int[]{1,2,3});
        ArrayList<GpuInt> bb = VecUtil.onesG(GpuInt.class, 3);
        VecUtil.printVec(aa);
        VecUtil.printVec(bb);
        System.out.println("---");
        if (progress < 3) { return; }
